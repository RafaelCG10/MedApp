  ...
  return (
    <div>
      <form className='w-full' onSubmit={authentication}>
        <span className='font-bold text-blue-500 py-2 block text-2x1'>Login</span>
        ...
        <div className='w-full py-2'>
          ...
          <input type='password' name='name' className='w-full border-[1px] border-gray-200 p-2 rounded-sm' onChange={(e:any) => setPassword(e.target.value)}/>
        </div>
        <div className='w-full py-2'>
